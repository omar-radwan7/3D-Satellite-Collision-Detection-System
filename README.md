...
![main-view](https://github.com/user-attachments/assets/22331fd0-9826-427b-96d7-163504f268a9)
...
<img width="1117" height="749" alt="debris-explosion" src="https://github.com/user-attachments/assets/c4c2fa2c-ba5e-4446-8e00-83b3eb622cbe" />
...
![satellite-detail](https://github.com/user-attachments/assets/84289d0a-41eb-42fd-b13e-05afd3627a86)
...
Mouse: Left-click drag to orbit camera, Shift+left-click drag to rotate Earth, right-click drag for free-flight mode, scroll to zoom.

Keyboard: WASD to move camera in free-flight mode, C to toggle camera modes, ESC to exit.

Interface: Mission Control panel provides Play/Pause/Stop buttons, speed slider up to 500x, and quick speed buttons. Display toggles for satellites, orbits, and debris. Conjunction analysis panel shows all near-miss events with risk levels, closest approach times, miss distances, and relative velocities.

Technical Details

Built with C++20 and OpenGL 4.1. Uses Keplerian orbital mechanics with two-body problem solutions. The conjunction analysis samples future positions and finds minimum distances between satellite pairs. Rendering uses instanced drawing for efficiency. The system handles dozens of satellites with real-time analysis, running conjunction prediction asynchronously every few seconds while collision detection runs every frame.

Configuration

Satellite definitions are in assets/config/satellites.json with orbital parameters including semi-major axis, eccentricity, inclination, right ascension of ascending node, argument of periapsis, and mean anomaly. The conjunction analyzer thresholds can be adjusted in code to control sensitivity and prediction window.

This project is open source and organized into logical modules with simulation logic separate from rendering, making it easy to understand, modify, and extend.
